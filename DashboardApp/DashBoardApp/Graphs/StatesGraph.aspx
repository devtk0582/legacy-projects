<%@ Page Title="" Language="C#" MasterPageFile="~/Graphs/GraphMaster.master" AutoEventWireup="true" CodeBehind="StatesGraph.aspx.cs" Inherits="DashBoardApp.Graphs.StatesGraph" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center">
                        <asp:LinkButton ID="lbTitle" runat="server" Text="States Graph" CssClass="graphTitle"></asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td align="center" valign="top" style="height: 200px;">
                        <asp:DataGrid ID="dgChart" ShowFooter="True" runat="server" AutoGenerateColumns="false"
                            ...
                            Font-Size="11px">
                            <Columns>
                                <asp:BoundColumn DataField="StateCode" SortExpression="StateName" HeaderText="State Name"></asp:BoundColumn>
                                <asp:BoundColumn DataField="Population" SortExpression="UserCount" HeaderText="Number Of Users"></asp:BoundColumn>
                            </Columns>
